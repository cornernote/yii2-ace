...
<?php if (!Yii::$app->user->isGuest): ?>
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul class="nav nav-list">
            ...
            <li class="<?php echo ($controller->module->id == 'user' && $controller->id == 'admin') || $controller->module->id == 'rbac' ? 'open active' : '' ?>">
                ...
                <ul class="submenu">
                    <li class="<?php echo $controller->module->id == 'user' && $controller->id == 'admin' && $controller->action->id == 'create' ? 'active' : '' ?>">
                    ...
                    <li class="<?php echo $controller->module->id == 'user' && $controller->id == 'admin' && $controller->action->id == 'index' ? 'active' : '' ?>">
                    ...
                    <li class="<?php echo $controller->module->id == 'rbac' && $controller->id == 'role' && $controller->action->id == 'index' ? 'active' : '' ?>">
                    ...
                    <li class="<?php echo $controller->module->id == 'rbac' && $controller->id == 'permission' && $controller->action->id == 'index' ? 'active' : '' ?>">
